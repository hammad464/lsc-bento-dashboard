    ...
    <div className="md:col-span-3 row-span-1 p-8 rounded-[2rem] bg-blue-600 dark:bg-[#B6F500] text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-300 border border-white/10">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              {isEditing ? (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    autoFocus
                    className="px-3 py-1 rounded-xl bg-white/20 dark:bg-black/10 text-white outline-none border border-white/30 dark:border-black/20 text-2xl font-extrabold focus:bg-white/30 dark:focus:bg-black/20 transition-all w-48 shadow-inner placeholder-white/50"
                  />
                  <button
                    onClick={saveName}
                    className="p-1.5 bg-white/20 dark:bg-black/10 hover:bg-white/35 dark:hover:bg-black/20 rounded-xl transition-colors text-white"
                  >
                    <Check size={18} />
                  </button>
                </div>
                ...
                <div className="flex items-center gap-2.5 group/name">
                  ...
                  <button
                    ...
                    className="p-1 bg-white/10 dark:bg-black/5 hover:bg-white/20 dark:hover:bg-black/15 opacity-0 group-hover/name:opacity-100 transition-all rounded-lg cursor-pointer text-white"
                    title="Edit name"
                  >
                    <Pencil size={12} />
                  </button>
          ...
          <div className="flex items-center space-x-2 text-indigo-50 bg-black/20 dark:bg-black/10 w-fit px-5 py-3 rounded-full backdrop-blur-sm border border-white/10 dark:border-black/5 shadow-sm">
